...
import com.fraime.android.rm2.databinding.FragmentListProgressBinding

class CharacterLoadStateAdapter : LoadStateAdapter<CharacterLoadStateAdapter.ProgressHolder>() {
    class ProgressHolder(private val binding: FragmentListProgressBinding) : RecyclerView.ViewHolder(binding.root){
